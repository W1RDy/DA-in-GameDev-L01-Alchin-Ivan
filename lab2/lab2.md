...
- Данное задание выполнено в сцене Unity, приложенной в репозиторие 

## Выводы

В ходе данной работы я научился заполнять таблицу Google Sheet в коде с помощью языка Python и получать данные из таблицы в скрипте Unity с помощью библиотеки JSON.
