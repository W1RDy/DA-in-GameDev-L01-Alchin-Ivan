...
### С диапазонами 5-14
![Изображение](Correlation5-14.png) 

### С диапазонами 1-6
![Изображение](Correlation1-6.png)

Таким образом коэффициент корреляции оказывает сильное влияние на обучение модели. Большой коэффициент корреляции з
